  ...
  return (
    <View className="bg-white p-4 rounded shadow-md mb-4">
      <View className="flex-row justify-between mb-2">
        <Text className="text-gray-800 font-medium capitalize">{transacao.tipoTransacao}</Text>
        <Text className="text-gray-500 text-xs">{dataFormatada}</Text>
      </View>

      <View className="flex-row justify-between items-center">
        <Text className="text-gray-800 font-semibold text-lg">R$ {transacao.valor}</Text>
